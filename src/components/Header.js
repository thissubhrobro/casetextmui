...
const pages = ['Casetext Research', 'Free CLE Webinars', 'Contact Us'];
    ...
    <>
      ...
      <Container maxWidth="xl">
        <Toolbar disableGutters>
          ...
          >
           <Avatar  width={176} src={imgaddr} alt='casetext'/>
          </Typography>
          ...
          <Box sx={{ flexGrow: 1, display: { xs: 'none', md: 'flex' } }}>
            {pages.map((page) => (
              <Link href='/'
                ...
                sx={{ m: 2, color: 'black', display: 'block',textDecoration:'none' }}     
                underline="hover"
              >
                {page}
              </Link>
